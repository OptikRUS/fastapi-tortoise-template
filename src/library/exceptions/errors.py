...
class SomeGenreNotFoundError(BaseNotFoundError):
    message: str = "Какой-то из жанров не найден."
    reason: str = "some_genres_not_found"
...
class BookCreationError(BaseBadRequestError):
    message: str = "Ошибка создания книги."
    reason: str = "book_creation_error"
